...
if(isset($_POST['emailreport']) && !empty($_POST['emailreport']))
{
	...
	$contents.="<br/>Reduced Labour Cost :".esc_html(sanitize_text_field($_POST['reducedlabourcost']));
	$contents.="<br/>Increased Revenue :".esc_html(sanitize_text_field($_POST['increasedrevenue']));
	$contents.="<br/>Fuel Savings :".esc_html(sanitize_text_field($_POST['fuelsavings']));
	$contents.="<br/>Service Reduction due to wear & tear :".esc_html(sanitize_text_field($_POST['servicereduction']));
	$contents.="<br/>Reduction in accidents :".esc_html(sanitize_text_field($_POST['accidentreduction']));
	$contents.="<br/><strong>Total Savings :".esc_html(sanitize_text_field($_POST['totalsavings'])).'</strong>';
