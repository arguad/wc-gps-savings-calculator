...
if(isset($_POST['emailreport']) && !empty($_POST['emailreport']))
{
	...
	$contents.="<br/>Reduced Labour Cost :". sanitize_text_field($_POST['reducedlabourcost']);
	$contents.="<br/>Increased Revenue :".sanitize_text_field($_POST['increasedrevenue']);
	$contents.="<br/>Fuel Savings :".sanitize_text_field($_POST['fuelsavings']);
	$contents.="<br/>Service Reduction due to wear & tear :".sanitize_text_field($_POST['servicereduction']);
	$contents.="<br/>Reduction in accidents :".sanitize_text_field($_POST['accidentreduction']);
	$contents.="<br/><strong>Total Savings :".sanitize_text_field($_POST['totalsavings']).'</strong>';

	$contents.="<br/><br/>Thank you";
	
	// escaping html before sending to mail
	$esc_content = esc_html($contents);

	$mailid = sanitize_email($_POST['emailreport']);
	if(wp_mail($mailid, $subject, $esc_content, $headers))
	{
